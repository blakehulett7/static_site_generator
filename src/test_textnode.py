    ...
    def test_split_function_bold(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                TextNode("test", "bold", None),
                TextNode(" string.", "text", None),
                TextNode("**this is a weird test string**", "bold", None),
                TextNode("", "text", None),
                TextNode("this", "bold", None),
                TextNode(" is a test ", "text", None),
                TextNode("string.", "bold", None),
                TextNode("", "text", None),
            ],
        )
    ...
    def test_split_function_italic(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                TextNode(" a test string.", "text", None),
                TextNode("*this is a weird test string*", "italic", None),
                TextNode("", "text", None),
                TextNode("this", "italic", None),
                TextNode(" is a test ", "text", None),
                TextNode("string.", "italic", None),
                TextNode("", "text", None),
            ],
        )
    ...
    def test_split_function_code(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                TextNode("a", "code", None),
                TextNode(" test string.", "text", None),
                TextNode("`this is a weird test string`", "code", None),
                TextNode("", "text", None),
                TextNode("this", "code", None),
                TextNode(" is a test ", "text", None),
                TextNode("string.", "code", None),
                TextNode("", "text", None),
            ],
        )
